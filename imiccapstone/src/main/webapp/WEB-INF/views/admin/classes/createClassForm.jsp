...
<div class="container">
	<div class="side-body page add-company-page">
		<div class="page-title">
			<div class="description">
				<ul class="breadcrumb">
					...
					<li class="active"><s:message code="add-class.lbl.add-class" /></li>
				</ul>							
			</div>
		...
		<!-- Form Create Class -->
		<div>
			<h3 align="center"><s:message code="add-class.lbl.add-class" /></h3>
				...
				<sf:form commandName="sClass" method="post" >
						...
						<div class="form-group row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right col-full-width">
								...
								<div
									...
									<sf:input path="sClassName" cssErrorClass="error" cssClass="form-control" id="userName" placeholder="" />
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									<div class='input-group date' id='datetimepicker1'>
					                 	 <sf:input path="startDate" cssClass="form-control" id="dob" />
											<sf:errors path="startDate" cssClass="help-block" />                 
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									<div class='input-group date' id='datetimepicker2'>
					                 	 <sf:input path="endDate" cssClass="form-control" id="endDate" />
											<sf:errors path="endDate" cssClass="help-block" />                 
					                     <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
					                     </span>
			                  		</div>
			                  	</div>						
						...
						<div class="form-group row">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									<div class='input-group date' id='datetimepicker3'>
					                 	 <sf:input path="lastUpdated" cssClass="form-control" id="lastUpdated" readonly="true" />
											<sf:errors path="lastUpdated" cssClass="help-block" />                 
					                     <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
					                     </span>
			                  		</div>
			                  	</div>	
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right col-full-width">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									...
									<sf:errors path="lastUpdatedBy" cssClass="help-block" />
								</div>
								<div class="clear-fix"></div>
							</div>
							<div class="clear-fix"></div>
					...
					<div class="box-footer text-center">
						<button type="submit" class="btn btn-info">
							<s:message code="add-roles.btn.save" />
						</button>
