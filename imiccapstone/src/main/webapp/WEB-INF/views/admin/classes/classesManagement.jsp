...
<div class="container">
	<div class="side-body page add-company-page">
		<div class="page-title">
			<div class="description">
				<ul class="breadcrumb">				
					...
					<li class="active"><s:message code="admin-home.lbl.classes" /></li>
				</ul>								
			</div>
			<div>
		...
		<h2 align="center"><s:message code="admin-home.lbl.classes" /></h2>		
	</div>
	...
	<div class="container" style="margin: 0 auto;">
		<div class="side-body page add-company-page">
			<h2 style="float:right">
				<a href="<%=request.getContextPath()%>/admin/createClassForm" class="btn btn-primary a-btn-slide-text">
					 <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
					<span><strong><s:message code="add-class.lbl.add-class"/></strong></span>  
				</a>
			</h2>		
		</div>
		<div class="side-body page add-company-page">	
			...
			<table class="table table-striped table-condensed">
				...
				<c:forEach var="sClass" items="${sClasses }">
					<tr>
						...
						<s:url value="/admin/viewUserProfile/{id}" var="urlViewUserProfile">
							<s:param name="id" value="${sClass.teacherId }"></s:param>
						</s:url>
						<td> <!-- 18/09/2017: Change to repair for having setting same id for all ids -->
						...
						<s:url value="/admin/viewClassDetail/{id}" var="urlView">
							<s:param name="id" value="${sClass.sClassId }"></s:param>
						</s:url>
						<td>
						...
						<s:url value="/admin/showEditClassForm/{id}" var="urlEdit">
							<s:param name="id" value="${sClass.sClassId }"></s:param>
						</s:url>			
						<td>
						...
						<td>
							<button type="submit" onclick="confirmDelete(${sClass.sClassId })" 
	...
	<script>	
		...
		function confirmDelete(idValue) {
		    ...
		    if (optionPicked == true) {
		        ...
		        window.location.href="<%=request.getContextPath()%>" + "/admin/deleteClass/" + idSelected;		        
		    } else {
