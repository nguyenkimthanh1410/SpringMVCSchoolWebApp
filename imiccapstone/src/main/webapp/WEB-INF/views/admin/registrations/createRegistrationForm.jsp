...
<div class="container">
	<div class="side-body page add-company-page">
		<div class="page-title">
			<div class="description">
				<ul class="breadcrumb">
					...
					<li class="active"><s:message code="add-registration.lbl.add-registration" /></li>
				</ul>							
			</div>
		...
		<div>
			<h3 align="center"><s:message code="add-registration.lbl.add-registration" /></h3>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right col-full-width">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									<div class='input-group date' id='datetimepicker1'>
					                 	 <sf:input path="regisDate" cssErrorClass="error" cssClass="form-control" id="regisDate" />
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right col-full-width">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-6 text-left col-full-width">
									<div class='input-group date' id='datetimepicker2'>
					                 	 <sf:input path="lastUpdated" cssClass="form-control" cssErrorClass="error" id="lastUpdated" readonly="true" />
