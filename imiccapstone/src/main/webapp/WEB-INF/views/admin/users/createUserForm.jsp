...
<div class="container">
	<div class="side-body page add-company-page">
		<div class="page-title">
			<div class="description">				
				<ul class="breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/admin/users.html"><s:message code="admin-home.lbl.users" /></a>
					</li>	
					<li class="active"><s:message code="add-user.lbl.add-user" /></li>
				</ul>				
			</div>
			<div>
		...
		<h3 align="center"><s:message code="add-user.lbl.add-user" /></h3>
						...
						<div class="form-group row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right col-full-width">
								...
								<div
									...
									<sf:input path="userName" cssErrorClass="error" cssClass="form-control" id="userName" placeholder="" readonly="true"/>
